...
def descentVarientStep(function:callable, evaluationPoint:np.array, stepDerivative: float, stepDescent:float, terminationCondition:float)->list[tuple[np.array, np.array]]:
